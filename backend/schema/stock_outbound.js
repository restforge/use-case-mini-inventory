...
/**
 * Schema definition for `stock_outbound`
 *
 * Generated by: npx restforge schema introspect
 * Generated at: 2026-06-03T03:09:33.153Z
 */
module.exports = ({ defineModel }) => defineModel('stock_outbound', {
  fields: {
    stock_outbound_id: 'string:36 pk',
    outbound_number: 'string:50 notnull unique',
    outbound_date: 'date notnull default:current_date',
